...
#Fuzzy c-means (FCM) is a data clustering technique in which a dataset is grouped into n clusters 
#with every datapoint in the dataset belonging to every cluster to a certain degree.
